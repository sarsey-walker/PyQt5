...
### Expectativa
Tentei criar uma aplicação em pyqt5 q faz uso da api 'Via Cep' que pega o CEP e guarda informações sobre esse CEP(nome cidade, bairro, entre outros dispoiveis) se o CEP for válido. E persiste essas informações em um banco de dados sqlite3. 
